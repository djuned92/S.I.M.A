    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <form class="form-horizontal aset" action="<?=base_url()?>staff_procurement/pencatatan_data_aset/add" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="<?=$invoice->name?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <input type="text" class="form-control" value="<?=$invoice->departement_name?>" disabled>
                        </div>

                        <label class="col-md-2 control-label">Departement Location</label>
                        <div class="col-md-4">
                            <input type="text" class="form-control" value="<?=$invoice->departement_location?>" disabled>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="id_brand" id="id_brand" required>
                                ...
                                <option value="<?=$r->id_brand?>"><?=$r->brand_name?></option>
                            <?php endforeach; ?>
                            </select>
                        </div>
                    </div> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input type="date" name="exp_date_wrr" class="form-control" placeholder="">
                        </div>
                    </div>  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            <select class="form-control" name="act_condition" required>
                                ...
                                <option value="Unuseable">Unuseable</option>
