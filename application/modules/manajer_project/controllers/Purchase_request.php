...
class Purchase_request extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->manajer_project('purchase_request/mp_purchase_request','script_manajer_project', $data);	
	}
	...
	public function add()
	{
		...
		{
			$this->template->manajer_project('purchase_request/mp_add_purchase_request','script_manajer_project');
		} 
		else 
		{
			$data = array(
	...
	public function update($id_purchase)
	{
		...
		if ($this->form_validation->run() == FALSE) 
		{
			...
			$this->template->manajer_project('purchase_request/mp_update_purchase_request','script_manajer_project', $data);
		} 
		else 
		{
			$data = array(
