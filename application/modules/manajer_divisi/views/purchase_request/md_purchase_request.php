<div class="content-wrapper">
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?=base_url()?>manajer_divisi/purchase_request/add"><button class="btn btn-primary btn-md"><i class="fa fa-plus"> Tambah Purchase Request</i></button></a>
                <br/><br/>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <!-- <td>
                                ...
                                <a href="<?=base_url()?>manajer_divisi/purchase_request/update/<?=$r->id_purchase?>"><button class="btn btn-sm btn-info btn-group"><i class="fa fa-edit"> Edit</i></button></a>
                            </td> -->
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
...
<div class="modal fade" id="delete<?=$r->id_purchase?>" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form action="<?=base_url()?>manajer_divisi/purchase_request/delete/<?=$r->id_purchase?>" class="form-horizontal" method="POST">
